...
DeviceNNVolume::Impl::render()
{
  ...
  if (shading)
    program.render(framebuffer_stream, params, volume, MethodRayMarching::SHADING, neural_occlusion, true);
  else
    program.render(framebuffer_stream, params, volume, MethodRayMarching::NO_SHADING, nullptr, false);
